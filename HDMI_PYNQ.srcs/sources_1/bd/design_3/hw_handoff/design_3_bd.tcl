...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "design2: hdmi in -> axi4 stream -> hdmi out
...
# Hierarchical cell: image_computing
proc create_hier_cell_image_computing { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_image_computing() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: HDMI_HPD, and set properties
  set HDMI_HPD [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 HDMI_HPD ]

  # Create instance: sobel_0, and set properties
  set sobel_0 [ create_bd_cell -type ip -vlnv Dennis:hls:sobel:1.0 sobel_0 ]
  ...
  connect_bd_intf_net -intf_net dvi2rgb_0_RGB [get_bd_intf_pins vid_io_in] [get_bd_intf_pins v_vid_in_axi4s_0/vid_io_in]
  connect_bd_intf_net -intf_net sobel_0_stream_out [get_bd_intf_pins sobel_0/stream_out] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  connect_bd_intf_net -intf_net v_axi4s_vid_out_0_vid_io_out [get_bd_intf_pins vid_io_out] [get_bd_intf_pins v_axi4s_vid_out_0/vid_io_out]
  connect_bd_intf_net -intf_net v_tc_0_vtiming_out [get_bd_intf_pins v_axi4s_vid_out_0/vtiming_in] [get_bd_intf_pins v_tc_0/vtiming_out]
  connect_bd_intf_net -intf_net v_vid_in_axi4s_0_video_out [get_bd_intf_pins sobel_0/stream_in] [get_bd_intf_pins v_vid_in_axi4s_0/video_out]
  ...
  connect_bd_net -net HDMI_HPD_dout1 [get_bd_pins hdmi_in_hpd] [get_bd_pins HDMI_HPD/dout] [get_bd_pins sobel_0/ap_rst_n] [get_bd_pins sobel_0/ap_start]
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins clk] [get_bd_pins sobel_0/ap_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: image_computing
  create_hier_cell_image_computing [current_bd_instance .] image_computing
  ...
  connect_bd_intf_net -intf_net dvi2rgb_0_RGB [get_bd_intf_pins dvi2rgb_0/RGB] [get_bd_intf_pins image_computing/vid_io_in]
  connect_bd_intf_net -intf_net rgb2dvi_0_TMDS [get_bd_intf_ports hdmi_out] [get_bd_intf_pins rgb2dvi_0/TMDS]
  connect_bd_intf_net -intf_net v_axi4s_vid_out_0_vid_io_out [get_bd_intf_pins image_computing/vid_io_out] [get_bd_intf_pins rgb2dvi_0/RGB]

  # Create port connections
  connect_bd_net -net HDMI_HPD_dout [get_bd_ports hdmi_in_hpd] [get_bd_pins image_computing/hdmi_in_hpd]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins dvi2rgb_0/RefClk]
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins image_computing/clk] [get_bd_pins rgb2dvi_0/PixelClk]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins xlconstant_0/dout]
