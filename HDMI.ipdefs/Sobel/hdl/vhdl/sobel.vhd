...
architecture behav of sobel is 
    ...
    "sobel,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=3,HLS_SYN_FF=1488,HLS_SYN_LUT=3277,HLS_VERSION=2019_2}";
    ...
    signal Block_proc_U0_img0_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Block_proc_U0_img0_rows_V_out_write : STD_LOGIC;
    signal Block_proc_U0_img0_cols_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal Sobel_1_U0_start_out : STD_LOGIC;
    signal Sobel_1_U0_start_write : STD_LOGIC;
    signal Sobel_1_U0_p_src_data_stream_0_V_read : STD_LOGIC;
    signal Sobel_1_U0_p_src_data_stream_1_V_read : STD_LOGIC;
    signal Sobel_1_U0_p_src_data_stream_2_V_read : STD_LOGIC;
    signal Sobel_1_U0_p_dst_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Sobel_1_U0_p_dst_data_stream_0_V_write : STD_LOGIC;
    signal Sobel_1_U0_p_dst_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Sobel_1_U0_p_dst_data_stream_1_V_write : STD_LOGIC;
    signal Sobel_1_U0_p_dst_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Sobel_1_U0_p_dst_data_stream_2_V_write : STD_LOGIC;
    ...
    signal img0_rows_V_c_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img0_rows_V_c_empty_n : STD_LOGIC;
    signal img0_cols_V_c_full_n : STD_LOGIC;
    signal img0_cols_V_c_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal img0_rows_V_c10_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img0_rows_V_c10_empty_n : STD_LOGIC;
    signal img0_cols_V_c11_full_n : STD_LOGIC;
    signal img0_cols_V_c11_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        img0_rows_V_out_din : OUT STD_LOGIC_VECTOR (10 downto 0);
        img0_rows_V_out_full_n : IN STD_LOGIC;
        img0_rows_V_out_write : OUT STD_LOGIC;
        img0_cols_V_out_din : OUT STD_LOGIC_VECTOR (11 downto 0);
    ...
    component start_for_Sobel_1ocq IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    img0_rows_V_c_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    img0_cols_V_c_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img0_rows_V_c10_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img0_cols_V_c11_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Sobel_1ocq_U : component start_for_Sobel_1ocq
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Sobel_1_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and Block_proc_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
